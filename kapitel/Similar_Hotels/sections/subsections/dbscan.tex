...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{cluster.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth, center]{dbscan_results_1_1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth, center]{dbscan_results_2_1.png}
